...
export function ResumeRichTextRead ({ value, className }: { value: string; className?: string }) {
...
function ResumeRichTextEdit ({
  ...
  if (!editor) {
    return <div className={cn('min-h-[4.5rem] rounded-md border border-slate-200 bg-white/50', className)} />
  }
  ...
  return (
    <div className={cn('rounded-md border border-slate-200 bg-white', className)}>
      <div className='flex flex-wrap gap-0.5 border-b border-slate-100 bg-slate-50/80 p-1'>
        ...
        <Button type='button' size='icon' variant='ghost' className='size-8' aria-label='Link' onClick={setLink}>
