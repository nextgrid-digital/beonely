...
export function PublicSiteHeader({ className }: { className?: string }) {
  ...
  return (
    <>
      ...
      <header
        className={cn(
          "fixed inset-x-0 top-0 z-50 bg-background/95 backdrop-blur transition-colors duration-200 supports-[backdrop-filter]:bg-background/80 motion-reduce:transition-none",
          className,
        )}
      >
        <div
...
export function PublicSiteFooter() {
  return (
    <footer className="mx-auto flex w-full max-w-5xl flex-col items-center justify-center border-t px-4 sm:px-6">
