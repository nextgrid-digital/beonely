...
1. **A Supabase project** with this app’s database rules applied (migrations in [`supabase/migrations/`](supabase/migrations/)). You do not need to “code” that—your developer or CI applies migrations once per environment.
